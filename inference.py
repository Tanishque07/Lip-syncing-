...
def getargs():
	...
	for i, segmented_video_file in enumerate(segmented_video_files):
		...
		face_files.append(segmented_video_file)
		audio_files.append(input_audio)
		output_files.append(output_file)

	return face_files, audio_files,output_files

def main():

	face_files, audio_files,output_files = getargs()
